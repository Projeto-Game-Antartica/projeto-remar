...
<div id="show-faseBiblioteca" class="content scaffold-show" role="main">
    ...
    <ol class="property-list faseBiblioteca">
        ...
        <g:if test="${faseBibliotecaInstance?.palavras}">
            <li class="fieldcontain">
                <span id="palavras-label" class="property-label"><g:message code="faseBiblioteca.palavras.label" default="Palavras" /></span>
